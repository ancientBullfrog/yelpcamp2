...
const { showCampground, renderNewForm, createCampground, renderEditForm, patchCampground, deleteCampground, showAllCampgrounds, showAllCampgroundsPage, getNearCampgrounds } = require('../controllers/campgrounds');
 ...
 */
router.route('/geolocate')
   .get(getNearCampgrounds);

router.get('/:page', showAllCampgroundsPage); // this will break the details page lookup
router.route('/:id')
   .get(showCampground)
